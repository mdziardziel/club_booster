class Member < ApplicationRecord
  ...
  validates :user_id, :club_id, presence: { message: I18nForPerson.t('errors.messages.blank', :male) }
  validates :user_id, uniqueness: { scope: :club_id, message: I18n.t('activerecord.errors.member.one_user_per_club_available') }
